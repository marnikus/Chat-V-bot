"""The pacing and appearance knobs of one run, in one immutable place.

`ScrollParser.__init__` used to take these as 17 keyword arguments, which meant
every phase threaded them along by hand. They are data now, and
`ScrollParser.from_options` is the constructor new code should use.
"""
