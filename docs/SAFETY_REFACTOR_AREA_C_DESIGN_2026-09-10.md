...
Parent: `docs/SAFETY_REFACTOR_2026-09-10_PLAN.md` + `docs/SAFETY_REFACTOR_AREA_C_2026-09-10.md`
...
docs/SAFETY_REFACTOR_AREA_C_2026-09-10.md           EDIT — append implementation journal only
docs/SAFETY_REFACTOR_AREA_C_DESIGN_2026-09-10.md    NEW — this file
```
...
- Actual branch/head, changed files, baseline repros, test commands/results,
  ...
  (Full journal lives in `docs/SAFETY_REFACTOR_AREA_C_2026-09-10.md`.)
