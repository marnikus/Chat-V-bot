...
This repository has **three current docs** and **88 archived ones**. That is
...
└── archive/                         ← historical. One folder per date+topic.
    ├── README.md                    ← index of all 88 archived docs
...
| Undo, locking, DB-window refresh, session trash | system of record §2, invariants I-10, I-17, I-18, I-19 | [`2026-09-11-db-undo-restore/`](archive/2026-09-11-db-undo-restore/DB_UNDO_RESTORE_DESIGN_2026-09-11.md) |
