...
This repository has **three current docs** and **101 archived ones**. That is
...
└── archive/                         ← historical. One folder per date+topic.
    ├── README.md                    ← index of all 101 archived docs
    ...
    └── 2026-09-14-round-h/           ← the ungated tail: the gate's blast radius + the H1–H10 plan (newest)
```
...
| `tests/` | The executable spec — 187 Python test files + 31 Node harness files |
...
| Size, parameter and test-debt rounds (F, G, H) | [`current/AGENT_RULES.md`](current/AGENT_RULES.md) RULE 16 / 18 / 19, and this map | [`2026-09-12-round-f-size-tail/`](archive/2026-09-12-round-f-size-tail/) (the 500-line tail and the two god classes), [`2026-09-13-round-f/`](archive/2026-09-13-round-f/) (the parameter objects), [`2026-09-13-round-g-write-gate/`](archive/2026-09-13-round-g-write-gate/) (the tail inventory and the executed steps G1–G7), [`2026-09-14-round-h/`](archive/2026-09-14-round-h/ROUND_H_DESIGN_2026-09-14.md) (the ungated tail and the H1–H10 plan), [`2026-09-13-rules-appendices/`](archive/2026-09-13-rules-appendices/) |
