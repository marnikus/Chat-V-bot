...
This repository has **three current docs** and **90 archived ones**. That is
...
└── archive/                         ← historical. One folder per date+topic.
    ├── README.md                    ← index of all 90 archived docs
    ...
    ├── 2026-09-13-round-g-write-gate/  ← Round G: the tail inventory + executed G1–G3, designed G4
    └── 2026-09-13-round-h-size-tail/   ← Round H: post-G metrics + the last four 500-line files (newest)
```
...
| Code complexity / size debt | [`current/AGENT_RULES.md`](current/AGENT_RULES.md) RULE 16, 18, 19 | [`reports/CODE_QUALITY_METRICS_2026-09-13.md`](../reports/CODE_QUALITY_METRICS_2026-09-13.md) (post-G snapshot), [`2026-09-13-round-h-size-tail/`](archive/2026-09-13-round-h-size-tail/) (the last four 500-line files), [`2026-09-11-cc-tail/`](archive/2026-09-11-cc-tail/CC_TAIL_FIXES_DESIGN_2026-09-11.md) (CC > 10 from 63 to 0) |
