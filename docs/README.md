...
This repository has **three current docs** and **79 archived ones**. That is
...
└── archive/                         ← historical. One folder per date+topic.
    ├── README.md                    ← index of all 83 archived docs
...
| `tests/` | The executable spec — 166 Python test files + 27 Node harness files |
