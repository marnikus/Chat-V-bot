...
Companion: `docs/AGENT_RULES.md` (behavioral product rules 1–15).
...
(`docs/AGENT_RULES.md` RULE 8). Coverage that only executes lines without
...
- Inferring control flow from a flag to drop a real exception branch
  (see rejected D3 in `docs/SAFETY_REFACTOR_AREA_C_CC_DESIGN_2026-09-10.md`).
