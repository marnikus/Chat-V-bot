...
> **Version:** 2026-09-09
> **Scope:** Section C of `docs/TEST_COVERAGE_REF_DESIGN_2026-09-09.md` — `backend/` engine & parser layer (22 modules, incl. their real homes in `services/` and `stores/` behind the compatibility shims).
