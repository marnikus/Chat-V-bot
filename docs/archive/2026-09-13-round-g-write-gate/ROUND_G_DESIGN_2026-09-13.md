...
ruling (§1c, freezes lifted), and G2 and G3 were executed as designed — each
with its own design doc and verification battery. G4–G7 remain planned, not
started.
