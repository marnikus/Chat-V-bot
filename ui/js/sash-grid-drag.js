/* sash-grid part — sash-grid-drag.js (Round H, H-A3)
   ...
   Two collaborating objects (H-A6, RULE 16 object cap):
     SashGridDrag         the drag lifecycle (pointer state machine)
     SashGridDragVisual   the drag visuals (clone / badge / indicator / flash)
   Drop-spec computation + sash resize live in sash-grid-spec.js.
   All parts merge onto the SashGrid facade — see ui/js/sash-grid.js.
   */
