/* ═══════════════════════════════════════════════════════════════
   ...
   ideal-size: 394 lines reason=one window = one controller, over RULE 18's
   300 the way bot-chat.js is over it, for the same constraint: `viewed` and
   `active` are two states of one popup, and splitting the controller that
   owns them would put one window in two files. The drawing half is
