...
const BUILTIN_BLOCKS = [
  ...
  { block_id:'SCROLL_PARSE',   name:'Scroll & Parse',    icon:'📜',
    defaults:{max_scrolls:50, scroll_pause_ms:800, scroll_delta_y:300,
              ...
              purge_rejected:true, skip_if_backlog:false, backlog_threshold:5,
    ...
    labels:{max_scrolls:'Max scrolls (safety cap)',
            ...
            skip_if_backlog:'⏸ Do not add new people while a backlog exists',
            backlog_threshold:'…if at least N un-messaged are in the list',
