/* sash-grid part — sash-grid-windows.js (Round H, H-A3/H-A6)

   Two collaborating objects:
     SashGridWindowStore   persistence: localStorage + backend round-trips
     SashGridWindows       window state ops: open/close/minimize/reset
   The menu + dock UI lives in sash-grid-menus.js. All parts merge onto
   the SashGrid facade — see ui/js/sash-grid.js.
   */
