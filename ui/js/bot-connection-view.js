/* ═══════════════════════════════════════════════════════════════
   ...
   ideal-size: 237 lines reason=one view = one module: the popup's markup and
   the difference between `viewed` and `active` are one subject. It also owns
   the element-id table, because which ids exist is a fact about the markup.
   ═══════════════════════════════════════════════════════════════ */
