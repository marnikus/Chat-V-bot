...
OWNED = [
    ...
    ("services/bot_grok.py", 'GrokSettings', "_write"),
    ("services/bot_grok.py", 'GrokSettings', "use"),
    ...
    ("bridge/bot_settings_bridge.py", 'BotSettingsBridge', "_settings_of"),
    ("bridge/bot_settings_bridge.py", 'BotSettingsBridge', "bot_providers"),
    ("bridge/bot_settings_bridge.py", 'BotSettingsBridge', "bot_save_provider"),
    ("bridge/bot_settings_bridge.py", 'BotSettingsBridge', "bot_use_provider"),
    ("bridge/bot_settings_bridge.py", 'BotSettingsBridge', "bot_test_provider"),
...
CLONE_BASELINE = frozenset({
    ...
    # Shrinking it would mean deleting a used import or reordering into a
