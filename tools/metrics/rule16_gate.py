...
OWNED = [
    # Area B: every extracted policy and scheduler method is measured.
    ('core/scheduler.py', 'Scheduler', 'now'),
    ('core/scheduler.py', 'Scheduler', 'sleep'),
    ('core/scheduler.py', 'Scheduler', 'until'),
    ('core/scheduler.py', None, 'poll'),
    ('core/scheduler.py', 'ManualScheduler', '__init__'),
    ('core/scheduler.py', 'ManualScheduler', 'now'),
    ('core/scheduler.py', 'ManualScheduler', 'sleep'),
    ('core/scheduler.py', 'ManualScheduler', 'until'),
    ('core/announcer.py', None, 'confirmed'),
    ('core/announcer.py', 'Announcer', '__init__'),
    ('core/announcer.py', 'Announcer', 'report'),
    ('core/announcer.py', 'Announcer', 'report_intent'),
    ('bridge/wire_codec.py', None, 'object_arg'),
    ('bridge/wire_codec.py', None, 'clean_nick'),
    ('bridge/wire_codec.py', None, 'message_id'),
    ('bridge/wire_codec.py', None, 'selection'),
    ('bridge/wire_codec.py', None, 'person_request'),
    ('bridge/wire_codec.py', None, 'people_payload'),
    ('bridge/wire_db.py', None, 'world_switched'),
    ('bridge/wire_db.py', None, 'rebuild_needed'),
    ('bridge/wire_db.py', None, 'undo_entry'),
    ('bridge/wire_db.py', None, 'success_text'),
    ('bridge/wire_undo.py', None, 'global_payload'),
    ('bridge/wire_undo.py', None, 'kind_value'),
    ('bridge/wire_undo.py', None, 'list_arg'),
    ('bridge/wire_undo.py', None, 'trim_history'),
    ('services/world_events.py', 'AsyncioScheduler', 'now'),
    ('services/world_events.py', 'AsyncioScheduler', 'sleep'),
    ('services/world_events.py', 'AsyncioScheduler', 'until'),
    ('services/world_events.py', 'WorldGate', '__init__'),
    ('services/world_events.py', 'WorldGate', 'wait'),
    ('services/world_events.py', 'WorldGate', 'run'),
    ('services/world_events.py', None, 'wait_for_world_open'),
    ('services/world_events.py', None, 'run_when_world_open'),
    ('services/world_events.py', None, 'announce_world_live'),
    ('services/world_events.py', None, '_announce_labels'),

    # Area A transfer: wire, typed private gate, selector and shim contracts.
    ('backend/cdp_transport.py', 'CdpConnection', '__aiter__'),
    ('backend/cdp_transport.py', 'CdpConnection', 'send'),
    ('backend/cdp_transport.py', 'CdpConnection', 'close'),
    ('backend/cdp_transport.py', 'CdpConnector', 'open'),
    ('backend/cdp_transport.py', 'TabDiscovery', 'list_tabs'),
    ('backend/cdp_transport.py', 'WebSocketConnection', '__init__'),
    ('backend/cdp_transport.py', 'WebSocketConnection', '__aiter__'),
    ('backend/cdp_transport.py', 'WebSocketConnection', '_frames'),
    ('backend/cdp_transport.py', 'WebSocketConnection', 'send'),
    ('backend/cdp_transport.py', 'WebSocketConnection', 'close'),
    ('backend/cdp_transport.py', 'WebSocketConnector', 'open'),
    ('backend/cdp_transport.py', 'HttpTabDiscovery', 'list_tabs'),
    ('backend/cdp_transport.py', None, 'default_wire'),
    ('backend/probe_results.py', None, '_text'),
    ('backend/probe_results.py', None, '_count'),
    ('backend/probe_results.py', None, '_names'),
    ('backend/probe_results.py', None, '_fingerprints'),
    ('backend/probe_results.py', 'PaneAuthors', 'split'),
    ('backend/probe_results.py', 'TabState', 'absent'),
    ('backend/probe_results.py', 'TabState', 'with_tab'),
    ('backend/probe_results.py', None, '_list_like'),
    ('backend/probe_results.py', None, 'decode_pane_authors'),
    ('backend/probe_results.py', None, 'decode_scroll_pos'),
    ('backend/probe_results.py', None, 'decode_tab_state'),
    ('backend/private_gate.py', 'PrivateCheck', '__bool__'),
    ('backend/private_gate.py', None, 'title_matches'),
    ('backend/private_gate.py', '_GateNames', 'read'),
    ('backend/private_gate.py', '_GateNames', 'effective_me'),
    ('backend/private_gate.py', '_GateNames', 'refuse'),
    ('backend/private_gate.py', None, '_is_self_chat'),
    ('backend/private_gate.py', None, '_split_authors'),
    ('backend/private_gate.py', None, '_authors_of'),
    ('backend/private_gate.py', None, '_foreign_authors'),
    ('backend/private_gate.py', None, 'judge_private'),
    ('backend/private_gate.py', None, '_tab_gate'),
    ('backend/private_gate.py', None, '_partner_gate'),
    ('backend/private_gate.py', None, '_title_gate'),
    ('backend/private_gate.py', None, '_strangers_verdict'),
    ('backend/selectors.py', None, 'selector'),
    ('backend/selectors.py', None, 'js_literal'),
    ('backend/selectors.py', None, 'js_literals'),
    ('backend/selectors.py', None, 'mirror_block'),
    ('backend/selectors.py', None, 'parse_mirror'),
    ('backend/legacy_shims.py', None, 'deprecated_module'),
    ('backend/cdp_ports.py', 'CdpTransport', 'connect'),
    ('backend/cdp_ports.py', 'CdpTransport', 'discover'),
    ('backend/cdp_ports.py', 'CombinedTransportAdapter', '__init__'),
    ('backend/cdp_ports.py', 'CombinedTransportAdapter', 'open'),
    ('backend/cdp_ports.py', 'CombinedTransportAdapter', 'list_tabs'),
    ('backend/cdp_client.py', 'CDPClient', 'with_wire'),
    ('backend/cdp_client.py', None, 'client_with_transport'),
    ('backend/cdp_client_transport.py', 'BrowserTransport', 'connect'),
    ('backend/cdp_client_transport.py', 'BrowserTransport', 'discover'),
    ('backend/cdp_client_transport.py', None, 'open_client'),
    ('backend/cdp_client_transport.py', None, '_fetch_tab_list'),
    ('backend/cdp_client_transport.py', None, 'receive_loop'),
    ('backend/chat_parser.py', None, 'verify_private'),
    ('backend/scroll_parser_dom.py', 'ScrollDom', 'snapshot'),
...
CLONE_BASELINE = frozenset({
    ...
    # Area B removed PeopleBridge's unused JSON import; existing pair remains.
