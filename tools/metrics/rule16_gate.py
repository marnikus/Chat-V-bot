...
CLONE_BASELINE = frozenset({
    ...
    #
    # The groups below are bridge IMPORT HEADERS — a match of imports, not of
    # logic. Shrinking one would mean deleting a used import or reordering
    # into a pylint C0411 warning: the cosmetic change §18.5 forbids.
    #
    # Two independent lines of work met here and BOTH facts are kept:
    #   * H3 dropped a dead `import os` from history_bridge.py (stranded by
    #     the H1 split), which made its header identical to the other
