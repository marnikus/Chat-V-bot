...
OWNED = [
    ...
    # ── Grid rows + adaptive restore (2026-09-14, Issue 4 / bug 5) ──
    ("services/preset_adapt.py", None, "_unique"),
    ("services/preset_adapt.py", None, "_usable"),
    ("services/preset_adapt.py", None, "_fits"),
    ("services/preset_adapt.py", None, "_spread"),
    ("services/preset_adapt.py", None, "_normalize_sizes"),
    ("services/preset_adapt.py", None, "_prune_leaf"),
    ("services/preset_adapt.py", None, "_child_size"),
    ("services/preset_adapt.py", None, "_pruned_split"),
    ("services/preset_adapt.py", None, "prune_grid_tree"),
    ("services/preset_adapt.py", None, "_tree_pruned"),
    ("services/preset_adapt.py", None, "_is_current_set"),
    ("services/preset_adapt.py", None, "adapt_tree"),
    ("services/preset_adapt.py", None, "adapt_states"),
    ("services/preset_adapt.py", None, "_entry_state"),
    ("services/preset_adapt.py", None, "_bound_number"),
    ("services/preset_adapt.py", None, "_entry_bounds"),
    ("services/preset_adapt.py", None, "_index_entries"),
    ("services/preset_adapt.py", None, "_canonical_entry"),
    ("services/preset_adapt.py", None, "_added_entry"),
    ("services/preset_adapt.py", None, "adapt_windows"),
    ("services/preset_adapt.py", None, "build_report"),
    ("services/window_preset_service.py", None, "_decode"),
    ("services/window_preset_service.py", None, "_text"),
    ("services/window_preset_service.py", None, "_header_error"),
    ("services/window_preset_service.py", None, "_preset_name"),
    ("services/window_preset_service.py", None, "_timestamp"),
    ("services/window_preset_service.py", None, "_header"),
    ("services/window_preset_service.py", None, "_grid_tree"),
    ("services/window_preset_service.py", None, "_grid"),
    ("services/window_preset_service.py", None, "_states"),
    ("services/window_preset_service.py", None, "_windows"),
    ("services/window_preset_service.py", None, "_number"),
    ("services/window_preset_service.py", None, "_screen"),
    ("services/window_preset_service.py", None, "_document_body"),
    ("services/window_preset_service.py", None, "validate_document"),
    ("services/window_preset_service.py", "WindowPresetService", "validate"),
    ("services/window_preset_service.py", "WindowPresetService",
     "compatibility_note"),
    ("services/window_preset_service.py", "WindowPresetService",
     "resolution_note"),
